...
function runTheRegister() {
  ...
  // Try to set the changeBox value and run the calcChange function
  try {
    // if changeValue is not greater than or equal to zero, throw an exception
    ...
    // Set the innerHTML of the element with the id "warning" to the value of the error
