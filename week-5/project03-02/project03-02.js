...
// Initialize variable to hold html code string
let htmlCode = "";

// Loop through all items in the captions array and generate html code with them
for (let i = 0; i < captions.length; i++) {
  // Concatenate HTML code to the htmlCode variable
  htmlCode +=
    "<figure>" +
    '<img alt="" src="slide' +
    i +
...
// Set the innerHTML of the element with the id "gallery" to the htmlCode variable
